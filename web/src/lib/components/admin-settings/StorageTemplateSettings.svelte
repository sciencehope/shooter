      ...
      <FormatMessage key="admin.storage_template_more_details">
        {#snippet children({ tag, message })}
          {#if tag === 'template-link'}
            <a
              href="https://docs.shooter.sciencehope.com/administration/storage-template"
              class="underline"
              target="_blank"
              rel="noreferrer"
            >
          ...
          {:else if tag === 'implications-link'}
            <a
              href="https://docs.shooter.sciencehope.com/administration/backup-and-restore#asset-types-and-storage-locations"
              class="underline"
              target="_blank"
              rel="noreferrer"
            >
